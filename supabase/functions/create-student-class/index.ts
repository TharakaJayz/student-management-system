...
import { CreateStudentClassesRequestSchema } from "../_shared/student-class/student-class.schema.ts"
...
Deno.serve(async (req) => {
  ...
  try {
    ...
    const parsedBody = CreateStudentClassesRequestSchema.safeParse(rawBody)
    ...
    const studentClasses = await studentClassFacade.createStudentClasses({
