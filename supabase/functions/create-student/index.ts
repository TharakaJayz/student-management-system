...
import { CreateStudentRequestSchema } from "../_shared/student/student.schema.ts"
...
Deno.serve(async (req) => {
  ...
  try {
    ...
    const parsedBody = CreateStudentRequestSchema.safeParse(rawBody)
    ...
    const student = await studentFacade.createStudent({
