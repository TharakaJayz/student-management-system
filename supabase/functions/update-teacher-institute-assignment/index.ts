...
import { UpdateTeacherInstituteAssignmentRequestSchema } from "../_shared/teacher-institute-assignment/teacher-institute-assignment.schema.ts"
...
Deno.serve(async (req) => {
  ...
  try {
    ...
    const parsedBody = UpdateTeacherInstituteAssignmentRequestSchema.safeParse(rawBody)
    ...
    const teacherInstituteAssignment = await assignmentFacade.updateTeacherInstituteAssignment({
