...
import { DeleteTeacherInstituteAssignmentRequestSchema } from "../_shared/teacher-institute-assignment/teacher-institute-assignment.schema.ts"
...
Deno.serve(async (req) => {
  ...
  try {
    ...
    const parsedBody = DeleteTeacherInstituteAssignmentRequestSchema.safeParse(rawBody)
    ...
    const teacherInstituteAssignment = await assignmentFacade.deleteTeacherInstituteAssignment({
