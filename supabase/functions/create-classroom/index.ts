...
import { CreateClassRoomRequestSchema } from "../_shared/classroom/classroom.schema.ts"
...
Deno.serve(async (req) => {
  ...
  try {
    ...
    const parsedBody = CreateClassRoomRequestSchema.safeParse(rawBody)
    ...
    const classRoom = await classRoomFacade.createClassRoom({
