...
import { DeleteStudentSubjectsRequestSchema } from "../_shared/student-subject/student-subject.schema.ts"
...
Deno.serve(async (req) => {
  ...
  try {
    ...
    const parsedBody = DeleteStudentSubjectsRequestSchema.safeParse(rawBody)
    ...
    const studentSubjects = await studentSubjectFacade.deleteStudentSubjects({
