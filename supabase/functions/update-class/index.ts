...
import { UpdateClassRequestSchema } from "../_shared/class/class.schema.ts"
...
Deno.serve(async (req) => {
  ...
  try {
    ...
    const parsedBody = UpdateClassRequestSchema.safeParse(rawBody)
    ...
    const cls = await classFacade.updateClass({
