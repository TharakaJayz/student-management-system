...
import { DeleteStudentInstituteEnrollmentRequestSchema } from "../_shared/student-institute-enrollment/student-institute-enrollment.schema.ts"
...
Deno.serve(async (req) => {
  ...
  try {
    ...
    const parsedBody = DeleteStudentInstituteEnrollmentRequestSchema.safeParse(rawBody)
    ...
    const studentInstituteEnrollment = await enrollmentFacade.deleteStudentInstituteEnrollment({
