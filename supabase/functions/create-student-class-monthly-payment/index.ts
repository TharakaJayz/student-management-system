...
import { CreateStudentClassMonthlyPaymentRequestSchema } from "../_shared/student-class-monthly-payment/student-class-monthly-payment.schema.ts"
...
Deno.serve(async (req) => {
  ...
  try {
    ...
    const parsedBody = CreateStudentClassMonthlyPaymentRequestSchema.safeParse(rawBody)
    ...
    const studentClassMonthlyPayment = await paymentFacade.createStudentClassMonthlyPayment({
