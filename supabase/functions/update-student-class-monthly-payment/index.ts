...
import { UpdateStudentClassMonthlyPaymentRequestSchema } from "../_shared/student-class-monthly-payment/student-class-monthly-payment.schema.ts"
...
Deno.serve(async (req) => {
  ...
  try {
    ...
    const parsedBody = UpdateStudentClassMonthlyPaymentRequestSchema.safeParse(rawBody)
    ...
    const studentClassMonthlyPayment = await paymentFacade.updateStudentClassMonthlyPayment({
