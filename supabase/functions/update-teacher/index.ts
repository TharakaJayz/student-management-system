...
import { UpdateTeacherRequestSchema } from "../_shared/teacher/teacher.schema.ts"
...
Deno.serve(async (req) => {
  ...
  try {
    ...
    const parsedBody = UpdateTeacherRequestSchema.safeParse(rawBody)
    ...
    const teacher = await teacherFacade.updateTeacher({
